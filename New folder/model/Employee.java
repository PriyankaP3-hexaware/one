...
public class Employee {
  ...
  */
  ...
  private int empPl;
  /**
   * empOl to store employee AvailableLeaves.
   */
  private int empOl;
  /**
  ...
  public final boolean equals(final Object obj) {
    ...
    if (Objects.equals(empId, emp.empId)
        ...
        && Objects.equals(empOl, emp.empOl)
  ...
  public final int hashCode() {
    return Objects.hash(empId, empFullName, empMobile, empEmail, empDeparment, empDateOfJoining, empMgrId,
                        empPl, empMl, empEl, empOl, empHrId);
  }
  @Override
  public final String toString() {
    ...
    return " EmpId:" + empId + " EmpName:" + empFullName + " EmpPhoneNo:"
             ...
             + empMgrId + " EmpML:" + empMl + "empOl" + empOl + "empHrId " + empHrId;
  }
  /**
   ...
   * @param argEmpOl to initialize employee AvailableLeave.
  ...
  public Employee(final int argEmpId, final String argEmpFullName, final String argEmpEmail,
                 ...
                 final int argEmpMgrId, final int argEmpPl, final int argEmpMl, final int argEmpEl,
                 final int argEmpOl, final int argHrId) {
    this.empId = argEmpId;
  ...
  public final void setEmpEl(final int argEmpEl) {
    this.empEl = argEmpEl;
      ...
      /**
   * @Gets the Employee Avaliable leave.
   * @return this Employee's oL
   */
  public final int getEmpOl() {
    return empOl;
  }
  /**
   * @param argEmpOl to set employee ol
   */
  public final void setEmpOl(final int argEmpOl) {
    this.empOl = argEmpOl;
  }
  /**
