...
public interface EmployeeDAO  {
  ...
  @SqlUpdate("UPDATE EMPLOYEE "
            +
            " SET EMP_ML = :balanceDays "
            +
            " WHERE EMP_ID =:empID")
  @Mapper(LeaveDetailsMapper.class)
  void ml(@Bind("balanceDays") int balanceDays,
  ...
  @SqlUpdate("UPDATE EMPLOYEE "
            +
            " SET EMP_EL = :balanceDays "
            +
            " WHERE EMP_ID =:empID")
  //@Mapper(LeaveDetailsMapper.class)
  void el(@Bind("balanceDays") int balanceDays,
             @Bind("empID") int empID);
               /**
   * Update Employee.
   * @param balanceDays applied leave days.
  ...
  @SqlUpdate("UPDATE EMPLOYEE "
            +
            " SET EMP_PL = :balanceDays "
            +
            " WHERE EMP_ID =:empID")
  //@Mapper(LeaveDetailsMapper.class)
  void pl(@Bind("balanceDays") int balanceDays,
          @Bind("empID") int empID);
